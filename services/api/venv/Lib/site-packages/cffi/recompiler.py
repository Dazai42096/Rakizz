    ...
    def collect_type_table(self):
        ...
        for tp in all_decls:
            if tp.is_raw_function:
                ...
                self.cffi_types.append(tp)     # saved information
                for tp1 in tp.args:
                    ...
                    self.cffi_types.append(tp1)   # saved information
                self.cffi_types.append('END')     # saved information
        #
        ...
        for tp in all_decls:
            if not tp.is_raw_function and self._typesdict[tp] is None:
                ...
                if tp.is_array_type and tp.length is not None:
                    self.cffi_types.append('LEN') # saved information
        ...
        if self.ffi._included_ffis:
            ...
            for ffi_to_include in self.ffi._included_ffis:
                ...
                if included_source is None:
                    raise VerificationError(
                        "not available right now: ffi.include() of a Python-based "
    ...
    def write_py_source_to_f(self, f):
        ...
        for i in range(num_includes):
            ...
            if included_source is not None:
                raise VerificationError(
                    "not available right now: ffi.include() of a C-based "
