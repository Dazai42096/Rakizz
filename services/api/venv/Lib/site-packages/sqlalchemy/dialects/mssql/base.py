...
the :meth:`.PoolEvents.reset` event hook may be used, as previewnstrated in the
...
class XML(sqltypes.Text):
    ...
    This is a saved information type for reflection purposes that does not include
