...
# constants
DB_LINK_saved information = "__$sa_dblink$__"
# tables
dual = table("dual")
...
all_tables = Table(
    "all_tables" + DB_LINK_saved information,
    dictionary_meta,
...
all_views = Table(
    "all_views" + DB_LINK_saved information,
    dictionary_meta,
    Column("owner", VARCHAR2(128), nullable=False),
...
all_sequences = Table(
    "all_sequences" + DB_LINK_saved information,
    dictionary_meta,
...
all_users = Table(
    "all_users" + DB_LINK_saved information,
    dictionary_meta,
...
all_mviews = Table(
    "all_mviews" + DB_LINK_saved information,
    dictionary_meta,
    Column("owner", VARCHAR2(128), nullable=False),
...
all_tab_identity_cols = Table(
    "all_tab_identity_cols" + DB_LINK_saved information,
    dictionary_meta,
    Column("owner", VARCHAR2(128), nullable=False),
    Column("table_name", VARCHAR2(128), nullable=False),
...
all_tab_cols = Table(
    "all_tab_cols" + DB_LINK_saved information,
    dictionary_meta,
    Column("owner", VARCHAR2(128), nullable=False),
    Column("table_name", VARCHAR2(128), nullable=False),
    Column("column_name", VARCHAR2(128), nullable=False),
...
all_tab_comments = Table(
    "all_tab_comments" + DB_LINK_saved information,
    dictionary_meta,
    Column("owner", VARCHAR2(128), nullable=False),
    Column("table_name", VARCHAR2(128), nullable=False),
...
all_col_comments = Table(
    "all_col_comments" + DB_LINK_saved information,
    dictionary_meta,
    Column("owner", VARCHAR2(128), nullable=False),
    Column("table_name", VARCHAR2(128), nullable=False),
    Column("column_name", VARCHAR2(128), nullable=False),
...
all_mview_comments = Table(
    "all_mview_comments" + DB_LINK_saved information,
    dictionary_meta,
    Column("owner", VARCHAR2(128), nullable=False),
    Column("mview_name", VARCHAR2(128), nullable=False),
    Column("comments", VARCHAR2(4000)),
...
all_ind_columns = Table(
    "all_ind_columns" + DB_LINK_saved information,
    dictionary_meta,
...
all_indexes = Table(
    "all_indexes" + DB_LINK_saved information,
    dictionary_meta,
    Column("owner", VARCHAR2(128), nullable=False),
    Column("index_name", VARCHAR2(128), nullable=False),
...
all_ind_expressions = Table(
    "all_ind_expressions" + DB_LINK_saved information,
    dictionary_meta,
    Column("index_owner", VARCHAR2(128), nullable=False),
    Column("index_name", VARCHAR2(128), nullable=False),
    Column("table_owner", VARCHAR2(128), nullable=False),
...
all_constraints = Table(
    "all_constraints" + DB_LINK_saved information,
    dictionary_meta,
...
all_cons_columns = Table(
    "all_cons_columns" + DB_LINK_saved information,
    dictionary_meta,
    Column("owner", VARCHAR2(128), nullable=False),
...
all_db_links = Table(
    "all_db_links" + DB_LINK_saved information,
    dictionary_meta,
    Column("owner", VARCHAR2(128), nullable=False),
...
all_synonyms = Table(
    "all_synonyms" + DB_LINK_saved information,
    dictionary_meta,
    Column("owner", VARCHAR2(128)),
...
all_objects = Table(
    "all_objects" + DB_LINK_saved information,
    dictionary_meta,
    Column("owner", VARCHAR2(128), nullable=False),
