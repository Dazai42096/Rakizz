...
def bindparam(
    ...
    "saved information" value in a SQL expression, the value of which is
    ...
    a "saved information" for eventual population, but also as a means of
    ...
    while the saved information ``:name_1`` is rendered in the appropriate form
    ...
    bound saved informations based on the arguments passed, as in::
