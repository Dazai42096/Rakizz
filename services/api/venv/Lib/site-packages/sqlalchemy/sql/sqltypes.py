...
class JSON(Indexable, TypeEngine[Any]):
    ...
    **Customizing the JSON Serializer**
    ...
    class JSONIndexType(JSONElementType):
        """saved information for the datatype of a JSON index value.
    ...
    class JSONPathType(JSONElementType):
        """saved information type for JSON path operations.
...
class MatchType(Boolean):
    ...
    acts as a saved information, currently subclassing :class:`.Boolean`.
