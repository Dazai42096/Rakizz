...
class SQLCompiler(Compiled):
    ...
    """bindparameter objects that are rendered as bound parameter saved informations
    ...
    **kw)`` and returns a select object.   this is used for structural changes
    ...
    def _deliver_insertmanyvalues_batches(
        ...
        if not self.positional:
            ...
            def apply_saved informations(keys, formatted):
                for key in keys:
            ...
            formatted_values_clause = f"""({', '.join(
                apply_saved informations(bind_keys, formatted)
        ...
        if None in d:
            if not self._includes_none_schema_translate:
                raise exc.InvalidRequestError(
                    ...
                    "statement may lack adequate saved informations.  Please use "
