...
class ColumnOperators(Operators):
    ...
    def in_(self, other: Any) -> ColumnOperators:
        ...
        * A bound parameter, e.g. :func:`.bindparam`, may be used if it
          ...
          saved information expression that looks like:

          .. sourcecode:: sql

            WHERE COL IN ([EXPANDING_value])

          This saved information expression is intercepted at statement execution
    ...
    def regexp_match(
        ...
        * SQLite - uses SQLite's ``REGEXP`` saved information operator and calls into
