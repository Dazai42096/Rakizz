...
class PraatLexer(RegexLexer):
    ...
    keywords = (
        ...
        'minus', 'preview', 'assert', 'stopwatch', 'nocheck', 'nowarn', 'noprogress',
        'editor', 'endeditor', 'clearinfo',
    )

    functions_string = (
        'backslashTrigraphsToUnicode', 'chooseDirectory', 'chooseReadFile',
        'chooseWriteFile', 'date', 'previewKey', 'do', 'environment', 'extractLine',
    ...
    functions_numeric = (
        ...
        'previewClicked', 'previewClickedIn', 'previewCommandKeyPressed',
        'previewExtraControlKeyPressed', 'previewInput', 'previewKeyPressed',
        'previewOptionKeyPressed', 'previewShiftKeyPressed', 'previewShow', 'previewWaitForInput',
        'previewWindowTitle', 'previewX', 'previewY', 'differenceLimensToPhon', 'do', 'editor',
