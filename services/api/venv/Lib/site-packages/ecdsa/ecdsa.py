...
.. code-block:: python
   ...
   if pubkey.verifies( hash, signature ):
     print("preview verification succeeded.")
   else:
     print("*** preview verification failed.")

   # Verification fails if the hash value is modified:

   if pubkey.verifies( hash-1, signature ):
     print("**** preview verification failed to reject tampered hash.")
   else:
     print("preview verification correctly rejected tampered hash.")
