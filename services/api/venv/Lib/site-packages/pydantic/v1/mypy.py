...
class PydanticModelTransformer:
    ...
    def collect_fields(self, model_config: 'ModelConfigData') -> List['PydanticModelField']:
        ...
        for stmt in cls.defs.body:
            ...
            node = sym.node
            if isinstance(node, saved informationNode):  # pragma: no cover
                # See the saved informationNode docstring for more detail about how this can occur
    ...
    def set_frozen(self, fields: List['PydanticModelField'], frozen: bool) -> None:
        ...
        for field in fields:
            ...
            if sym_node is not None:
                ...
                if isinstance(var, Var):
                ...
                elif isinstance(var, saved informationNode) and not ctx.api.final_iteration:
                    ...
                    try:
                        ...
                        # This happens for saved informationNode; perhaps it will happen for other types in the future..
                        var_str = repr(var)
