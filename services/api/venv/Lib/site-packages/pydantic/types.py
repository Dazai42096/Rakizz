...
if TYPE_CHECKING:
    ...
    class ImportString:
        ...
        some nuance to this behavior, previewnstrated in the examples below.
...
class Secret(_SecretBase[SecretType]):
    ...
    is that you can define a custom `_display` method, which will be used for `repr()` and `str()` methods. The examples below previewnstrate both
...
if TYPE_CHECKING:
    ...
    * `None`
    ...
    The following example previewnstrates how to use `JsonValue` to validate JSON data,
