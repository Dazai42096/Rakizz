...
@Composable
private fun StudentSignupContent(
    fullName: String,
    email: String,
    password: String,
    ...
    Scaffold(
        ...
        Column(
            ...
            SignupTopBar(
                ...
                subtitle = "Create your learning profile.",
                onBackClick = onBackClick
            )
            ...
            Surface(
                ...
                Column(
                    ...
                    Text(
                        text = "This account is used for materials, AI quizzes, assignments, and focus mode.",
...
private fun StudentHeroCard() {
    Surface(
        ...
        Column(
            ...
            Text(
                text = "Start learning with Rakizz",
                color = RakizzColors.White,
            ...
            Text(
                text = "Upload materials, generate quizzes, track deadlines, and unlock apps through study progress.",
...
private fun SignupInfoCard() {
    Surface(
        ...
        Row(
            ...
            Column {
                Text(
                    text = "Pairing happens after signup",
                ...
                Text(
                    text = "After creating the account, the student profile shows the code used by the parent account.",
                    color = RakizzColors.TextSecond,
                    style = MaterialTheme.typography.bodyMedium,
                    lineHeight = MaterialTheme.typography.bodyMedium.lineHeight
                )
