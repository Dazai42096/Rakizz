...
import com.rakizz.student.BuildConfig
import com.rakizz.student.data.network.AuthInterceptor
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideRakizzApi(retrofit: Retrofit): RakizzApi {
        return retrofit.create(RakizzApi::class.java)
    }
}
